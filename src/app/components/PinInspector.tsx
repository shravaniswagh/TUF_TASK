...
export function PinInspector({ pin, onUpdate, onClose, onDelete, isDark }: PinInspectorProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 bottom-0 w-[350px] bg-white/70 dark:bg-slate-900/70 backdrop-blur-[32px] shadow-[-32px_0_64px_rgba(0,0,0,0.1)] border-l border-white/40 dark:border-slate-800/40 z-[100000] flex flex-col overflow-hidden"
