      ...
      >
        ...
        >
          ...
          >
            ...
            <span className={`text-[10px] font-black uppercase tracking-[0.2em] opacity-40 ${textColorClass.includes('slate-50') ? 'text-white' : 'text-slate-900'}`}>Weekly Analysis</span>
          </div>
